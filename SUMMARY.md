...
* [Integration Modes](integration-guides/integrations-modes/README.md)
  * [APIs](integration-guides/integrations-modes/direct/README.md)
    ...
    * [🆕 Snippet code for simulation widget](integration-guides/integrations-modes/direct/snippet-code-for-simulation-widget/README.md)
      * [Snippet front guide](integration-guides/integrations-modes/direct/snippet-code-for-simulation-widget/snippet-front-guide.md)
      * [Snippet back-end guide (optional)](integration-guides/integrations-modes/direct/snippet-code-for-simulation-widget/snippet-back-end-guide-optional.md)
...
* [🆕 e-Financing API](api-reference/e-financing-api/README.md)
  * [V 1.7.1 - e-Financing API](api-reference/e-financing-api/v-1.7.1-e-financing-api.md)
  * [Depreciated versions e-Financing API](api-reference/e-financing-api/depreciated-versions-e-financing-api/README.md)
    * [V 1.7.0 - e-Financing API](api-reference/e-financing-api/depreciated-versions-e-financing-api/v-1.7.0-e-financing-api.md)
    * [V 1.6.6 - e-Financing API](api-reference/e-financing-api/depreciated-versions-e-financing-api/v-1.6.6-e-financing-api.md)
