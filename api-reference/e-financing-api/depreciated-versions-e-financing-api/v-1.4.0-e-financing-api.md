---
description: Version 1.4.0 - depreciated
hidden: true
---
...
{% swagger src="../../../.gitbook/assets/swagger_e-financing_1.4.0_uatc (3).yaml" path="/eligible-solutions" method="get" %}
[swagger_e-financing_1.4.0_uatc (3).yaml](<../../../.gitbook/assets/swagger_e-financing_1.4.0_uatc (3).yaml>)
{% endswagger %}

### Simulations

{% swagger src="../../../.gitbook/assets/swagger_e-financing_1.4.0_uatc (3).yaml" path="/_simulate-solutions" method="post" %}
[swagger_e-financing_1.4.0_uatc (3).yaml](<../../../.gitbook/assets/swagger_e-financing_1.4.0_uatc (3).yaml>)
{% endswagger %}
...
{% swagger src="../../../.gitbook/assets/swagger_e-financing_1.4.0_uatc (3).yaml" path="/subscriptions" method="get" %}
[swagger_e-financing_1.4.0_uatc (3).yaml](<../../../.gitbook/assets/swagger_e-financing_1.4.0_uatc (3).yaml>)
{% endswagger %}

{% swagger src="../../../.gitbook/assets/swagger_e-financing_1.4.0_uatc (3).yaml" path="/subscriptions" method="post" %}
[swagger_e-financing_1.4.0_uatc (3).yaml](<../../../.gitbook/assets/swagger_e-financing_1.4.0_uatc (3).yaml>)
{% endswagger %}

{% swagger src="../../../.gitbook/assets/swagger_e-financing_1.4.0_uatc (3).yaml" path="/subscriptions/{creditSubscriptionId}" method="get" %}
[swagger_e-financing_1.4.0_uatc (3).yaml](<../../../.gitbook/assets/swagger_e-financing_1.4.0_uatc (3).yaml>)
{% endswagger %}

### Delivery

{% swagger src="../../../.gitbook/assets/swagger_e-financing_1.4.0_uatc (3).yaml" path="/subscriptions/{creditSubscriptionId}/_confirmDelivery" method="post" %}
[swagger_e-financing_1.4.0_uatc (3).yaml](<../../../.gitbook/assets/swagger_e-financing_1.4.0_uatc (3).yaml>)
{% endswagger %}

### Cancellations

{% swagger src="../../../.gitbook/assets/swagger_e-financing_1.4.0_uatc (3).yaml" path="/subscriptions/{creditSubscriptionId}/_cancel" method="post" %}
[swagger_e-financing_1.4.0_uatc (3).yaml](<../../../.gitbook/assets/swagger_e-financing_1.4.0_uatc (3).yaml>)
{% endswagger %}

Download OpenAPI specs:

{% file src="../../../.gitbook/assets/swagger_e-financing_1.4.0_uatc (2).yaml" %}
