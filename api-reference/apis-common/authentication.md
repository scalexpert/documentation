...
1. Application sends [application's credentials](../../for-customers/before-you-start/api-key.md#3-api-key) to the oAuth2 Authorization Server with the [authorization scopes](scopes.md) you want to access.&#x20;
