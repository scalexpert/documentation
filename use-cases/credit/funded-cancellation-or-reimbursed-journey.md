...
The Financing journey (credit or payment) is considered as FUNDED accordingly the general conditions of the solution. Thus, the merchant will be informed by an events and a the [status](e-financing-status-life-cycle.md) will be visible in its portal.&#x20;
...
The [status](e-financing-status-life-cycle.md) of the subscription will be updated to CANCELLED or REIMBURSED (REFUND):
