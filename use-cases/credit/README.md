...
The 2 kinds are integrated with the  [`API Credit`](../../api-reference/e-financing-api.md) . You will have to select the [`solution code` ](#user-content-fn-1)[^1]accordingly the combination depicted below and according what you have contracted.
